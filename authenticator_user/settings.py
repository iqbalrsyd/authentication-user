...
env = environ.Env(
    ...
    RECAPTCHA_TIMEOUT_SECONDS=(int, 5),
    RECAPTCHA_ALLOWED_HOSTNAMES=(list, []),
)
...
RECAPTCHA_TIMEOUT_SECONDS = env("RECAPTCHA_TIMEOUT_SECONDS")
RECAPTCHA_ALLOWED_HOSTNAMES = env("RECAPTCHA_ALLOWED_HOSTNAMES")
